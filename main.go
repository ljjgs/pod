...
func main() {
	...
	dataService := service2.NewPodDataService(repository.NewPodRepository(db),
		clientSet,
	)
	pod.RegisterPodHandler(service.Server(), &handler.PodHandler{PodDataService: dataService})
